...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},bv=class extends cv{constructor(){super(),this.isOutputPass=!0,this.uniforms=Np.clone(yv.uniforms),this.material=new Lp({name:yv.name,uniforms:this.uniforms,vertexShader:yv.vertexShader,fragmentShader:yv.fragmentShader}),this._fsQuad=new dv(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Yl.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},xv=.3,Sv=.3;function Cv(e,t,n,r){let i=new qf(e,t,6,14);r.push(i);let a=new pf(i,n);return a.castShadow=!0,a}function wv(e,t,n,r=18,i=14){let a=new Ep(e,r,i);n.push(a);let o=new pf(a,t);return o.castShadow=!0,o}function Tv(e,t,n,r,i){let a=new Kf(e,t,n);i.push(a);let o=new pf(a,r);return o.castShadow=!0,o}function Ev(e){let t=[],n=new zp({color:e.skin,roughness:.58,metalness:.02,clearcoat:.25,clearcoatRoughness:.6}),r=new Rp({color:e.skinShadow,roughness:.58,metalness:.02}),i=new Rp({color:e.trunks,roughness:.34,metalness:.05}),a=new Rp({color:e.trunkTrim,roughness:.4,metalness:.1}),o=new Rp({color:e.glove,roughness:.28,metalness:.04}),s=new Rp({color:e.gloveTrim,roughness:.45}),c=new Rp({color:e.hair,roughness:.72}),l=new Rp({color:e.shoe,roughness:.5}),u=new Rp({color:4856918,roughness:.9,transparent:!0,opacity:0}),d=u.clone(),f=u.clone(),p=new Rp({color:8326420,roughness:.6,transparent:!0,opacity:0,emissive:2753286}),m=p.clone(),h=[n,r,i,a,o,s,c,l,u,d,f,p,m],g=new zu;g.name=`boxer`;let _=new zu;_.name=`hips`,_.position.y=.98,g.add(_);let v=Cv(.145,.1,i,t);v.scale.set(1.18,1,.88),v.position.y=.02,_.add(v);let y=new pf(new Yf(.168,.172,.035,18),a);t.push(y.geometry),y.scale.set(1.05,1,.82),y.position.y=.1,y.castShadow=!0,_.add(y);let b=new zu;b.name=`spine`,b.position.y=.1,_.add(b);let x=new zu;x.name=`chest`,b.add(x);let S=Cv(.16,.2,n,t);S.scale.set(1.3,1,.82),S.position.y=.19,x.add(S);let C=Cv(.125,.1,n,t);C.scale.set(1.22,1,.8),C.position.y=.02,x.add(C);let w=wv(.062,n,t);w.scale.set(1.05,.78,.6),w.position.set(.085,.26,.115),x.add(w);let T=w.clone();T.position.x=-.085,x.add(T);let E=wv(.075,n,t);E.position.set(.215,.315,0),x.add(E);let D=E.clone();D.position.x=-.215,x.add(D);let O=wv(.1,f,t);O.scale.set(1.05,1.35,.55),O.position.set(.02,.05,.1),O.castShadow=!1,x.add(O);let k=new zu;k.name=`head`,k.position.y=.44,x.add(k);let A=new pf(new Yf(.052,.062,.09,12),r);t.push(A.geometry),A.position.y=.02,A.castShadow=!0,k.add(A);let ee=wv(.115,n,t,22,18);ee.scale.set(.92,1.08,.98),ee.position.y=.135,k.add(ee);let te=wv(.085,n,t,16,12);te.scale.set(.85,.72,.9),te.position.set(0,.075,.028),k.add(te);let j=Tv(.032,.045,.035,r,t);j.position.set(0,.12,.112),k.add(j);let ne=Tv(.052,.016,.02,r,t);ne.position.set(.048,.165,.1),k.add(ne);let re=ne.clone();re.position.x=-.048,k.add(re);let ie=wv(.026,r,t,10,8);ie.scale.set(.5,1,.75),ie.position.set(.104,.125,.01),k.add(ie);let ae=ie.clone();ae.position.x=-.104,k.add(ae);let oe=new Rp({color:1315344,roughness:.35});h.push(oe);let se=wv(.016,oe,t,8,8);se.position.set(.045,.145,.102),k.add(se);let ce=se.clone();ce.position.x=-.045,k.add(ce);let le=wv(.118,c,t,20,14);le.scale.set(.94,.98,1),le.position.set(0,.165,-.018),k.add(le);let M=wv(.112,c,t,18,12);M.scale.set(.9,.58,.95),M.position.set(0,.198,.012),k.add(M);let ue=wv(.042,u,t,12,10);ue.scale.set(1,.72,.5),ue.position.set(.05,.15,.085),ue.castShadow=!1,k.add(ue);let de=wv(.042,d,t,12,10);de.scale.set(1,.72,.5),de.position.set(-.05,.15,.085),de.castShadow=!1,k.add(de);let fe=Tv(.05,.008,.01,p,t);fe.position.set(.05,.178,.104),fe.castShadow=!1,k.add(fe);let pe=Tv(.05,.008,.01,m,t);pe.position.set(-.05,.178,.104),pe.castShadow=!1,k.add(pe);let me=e=>{let r=new zu;r.name=e===1?`shoulderL`:`shoulderR`,r.position.set(.215*e,.315,0),x.add(r);let i=Cv(.056,xv-.12,n,t);i.position.y=-.3/2,r.add(i);let a=new zu;a.name=e===1?`elbowL`:`elbowR`,a.position.y=-.3,r.add(a);let c=Cv(.048,Sv-.13,n,t);c.position.y=-.13999999999999999,a.add(c);let l=new zu;l.name=e===1?`gloveL`:`gloveR`,l.position.y=-.3,a.add(l);let u=new pf(new Yf(.055,.062,.07,12),s);t.push(u.geometry),u.position.y=.01,u.castShadow=!0,l.add(u);let d=wv(.088,o,t,18,14);return d.scale.set(1,1.12,1.3),d.position.set(0,-.05,.02),l.add(d),{shoulder:r,elbow:a,glove:l,gloveMesh:d}},he=me(1),ge=me(-1),_e=e=>{let r=new zu;r.name=e===1?`hipL`:`hipR`,r.position.set(.105*e,-.02,0),_.add(r);let a=Cv(.078,.24,n,t);a.position.y=-.21,r.add(a);let o=Cv(.092,.16,i,t);o.position.y=-.14,r.add(o);let s=new zu;s.name=e===1?`kneeL`:`kneeR`,s.position.y=-.44,r.add(s);let c=Cv(.058,.24,n,t);c.position.y=-.21,s.add(c);let u=new zu;u.name=e===1?`ankleL`:`ankleR`,u.position.y=-.44,s.add(u);let d=Tv(.095,.075,.26,l,t);d.position.set(0,-.035,.055),u.add(d);let f=new pf(new Yf(.052,.058,.08,10),l);return t.push(f.geometry),f.position.y=.01,f.castShadow=!0,u.add(f),{hip:r,knee:s,ankle:u}},ve=_e(1),ye=_e(-1);return{root:g,hips:_,spine:b,chest:x,head:k,shoulderL:he.shoulder,elbowL:he.elbow,gloveL:he.glove,shoulderR:ge.shoulder,elbowR:ge.elbow,gloveR:ge.glove,hipL:ve.hip,kneeL:ve.knee,ankleL:ve.ankle,hipR:ye.hip,kneeR:ye.knee,ankleR:ye.ankle,chestMesh:S,headMesh:ee,browL:ne,browR:re,bruiseL:ue,bruiseR:de,bodyBruise:O,cutL:fe,cutR:pe,gloveLMesh:he.gloveMesh,gloveRMesh:ge.gloveMesh,materials:h,geometries:t}}var Dv=new Q,Ov=new Q,kv=new Q,Av=new Q,jv=new Q,Mv=new Q,Nv=new Q(0,-1,0),Pv=new Q;function Fv(e,t,n,r){let i=xv,a=.36;Dv.copy(e),Ov.copy(t),kv.subVectors(Ov,Dv);let o=Bl.clamp(kv.length(),.12,.6449999999999999);kv.normalize();let s=(i*i-a*a+o*o)/(2*o),c=Math.sqrt(Math.max(1e-4,i*i-s*s));Mv.copy(n).normalize(),Av.copy(Mv).addScaledVector(kv,-Mv.dot(kv)),Av.lengthSq()<1e-4&&Av.set(0,-1,0).addScaledVector(kv,kv.y),Av.normalize(),jv.copy(Dv).addScaledVector(kv,s).addScaledVector(Av,c),r.elbowWorld.copy(jv),Pv.copy(Dv).addScaledVector(kv,o),Ov.copy(Pv)}var Iv=new Q,Lv=new Vl,Rv=new Vl;new Vl;function zv(e,t,n,r=0){if(Iv.subVectors(n,t),Iv.lengthSq()<1e-6)return;if(Iv.normalize(),Rv.setFromUnitVectors(Nv,Iv),r!==0){let e=new Vl().setFromAxisAngle(Iv,r);Rv.premultiply(e)}let i=e.parent;if(i===null){e.quaternion.copy(Rv);return}i.getWorldQuaternion(Lv),e.quaternion.copy(Lv.invert().multiply(Rv))}function Bv(){let e=Ev({skin:13081462,skinShadow:11041884,trunks:1316380,trunkTrim:1316380,glove:13081462,gloveTrim:15264236,hair:2827040,shoe:1052948}),t=new Rp({color:12568015,roughness:.72}),n=new Rp({color:1316380,roughness:.7}),r=new pf(new qf(.175,.24,6,14),t);r.scale.set(1.28,1,.85),r.position.y=.15,r.castShadow=!0,e.chest.add(r);let i=new pf(new Yf(.07,.09,.05,12),t);i.position.y=.42,e.chest.add(i);let a=new pf(new Kf(.07,.025,.02),n);a.position.set(0,.4,.09),e.chest.add(a);let o=[r.geometry,i.geometry,a.geometry];for(let n of[e.shoulderL,e.shoulderR]){let e=new pf(new qf(.062,.16,4,10),t);e.position.y=-.12,e.castShadow=!0,n.add(e),o.push(e.geometry)}for(let t of[e.hipL,e.hipR]){let e=new pf(new qf(.088,.26,4,10),n);e.position.y=-.21,e.castShadow=!0,t.add(e),o.push(e.geometry)}for(let t of[e.kneeL,e.kneeR]){let e=new pf(new qf(.066,.26,4,10),n);e.position.y=-.21,e.castShadow=!0,t.add(e),o.push(e.geometry)}return e.geometries.push(...o),e.materials.push(t,n),e}function Vv(e){for(let t of e.geometries)t.dispose();for(let t of e.materials)t.dispose()}var Hv=new Q(.1,.27,.27),Uv=new Q(-.09,.29,.23),Wv=new Q(.13,0,.26),Gv=new Q(-.11,.02,.22),Kv=new Q(.13,.1,.28),qv=new Q(-.11,.14,.24),Jv={jab:.3,straight:.38,hook:.44,uppercut:.46},Yv=.33,Xv=-.02;function Zv(e,t,n){let r=n===`power`?.12:0,i=t===`head`?Yv:Xv;switch(e){case`jab`:return new Q(.06,i,.56+r*.5);case`straight`:return new Q(-.04,i,.62+r*.5);case`hook`:return new Q(-.3,i+.02,.48+r*.4);case`uppercut`:return new Q(0,i+.1,.46+r*.4)}}var Qv=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),$v=(e,t,n,r)=>e+(((t-e+Math.PI)%(Math.PI*2)+Math.PI*2)%(Math.PI*2)-Math.PI)*(1-Math.exp(-n*r)),ey=(e,t,n)=>{let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)},ty=new Q,ny=new Q,ry=new Q,iy={elbowWorld:new Q},ay=new Q,oy=class{rig;mapping;yaw=0;punchT=1;punchKind=null;punchHand=`left`;punchTargetKind=`head`;punchPower=`normal`;activeAction=null;downAmount=0;reactionT=1;reactionDirection=1;reactionPower=0;walkPhase=0;gloveLCurrent=new Q().copy(Kv);gloveRCurrent=new Q().copy(qv);hipsRoll=0;spinePitch=0;spineTwist=0;drop=0;constructor(e,t){this.rig=e,this.mapping=t}impact(e){(e.amount>this.reactionPower||this.reactionT>.4)&&(this.reactionT=0,this.reactionDirection=e.direction,this.reactionPower=Math.max(this.reactionPower*.4,e.amount))}update(e,t,n,r,i){let a=this.rig,o=e.stance===`orthodox`?1:-1,s=this.mapping.x(e.x),c=this.mapping.z(e.y),l=Math.atan2(this.mapping.x(t.x)-s,(this.mapping.z(t.y)-c)*.45);this.yaw=$v(this.yaw,l,7,n),e.action!==this.activeAction&&(e.action!==null&&(this.punchT=0,this.punchKind=e.action,this.punchHand=e.action_hand??(e.stance===`orthodox`?`left`:`right`),this.punchTargetKind=e.action_target??`head`,this.punchPower=e.action_power??`normal`),this.activeAction=e.action);let u=this.punchKind===null?1:Jv[this.punchKind]*(this.punchPower===`power`?1.3:1);this.punchT=Math.min(1,this.punchT+n/u);let d=1-e.stamina/Math.max(1,e.maximum_stamina),f=Math.hypot(e.velocity_x,e.velocity_y)*.006;this.walkPhase+=f*n*4.4;let p=+!!e.is_downed,m=e.is_downed?2.6:1.5;this.downAmount=Qv(this.downAmount,p,m,n);let h=ey(0,1,this.downAmount);this.reactionT=Math.min(1,this.reactionT+n/.42);let g=(1-ey(0,1,this.reactionT))*Math.min(1,this.reactionPower/220),_=Math.min(1,e.stunned_ticks/45),v=i?0:Math.sin(r*8.6)*.05*_,y=i||h>.5?0:Math.sin(r*(4.6-d*1.6)+this.walkPhase*.5)*(.014+d*.012),b=i?0:Math.sin(r*(2.2+d*2.6))*(.012+d*.03),x=0,S=0,C=0;e.defense===`weave`?(x=-.24,S=.34*o,C=.3):e.defense===`slip_left`?(S=.2,C=.06):e.defense===`slip_right`?(S=-.2,C=.06):e.defense===`pull`&&(C=-.3),e.is_foul_recovery_target&&(x=-.18,C=.42),(e.clinch_ticks>0||e.clinch_startup_ticks>0)&&(C=.4,x=-.06),x-=g*.05,C-=g*.34,S+=v,this.drop=Qv(this.drop,x,12,n),this.hipsRoll=Qv(this.hipsRoll,S,12,n),this.spinePitch=Qv(this.spinePitch,C,11,n);let w=0;if(this.punchT<1&&this.punchKind!==null){let e=ey(.16,.5,this.punchT)*(1-ey(.6,1,this.punchT));this.punchKind===`straight`&&(w=-.42*e*(this.punchHand===`left`?1:-1)*o),this.punchKind===`hook`&&(w=.4*e*(this.punchHand===`left`?1:-1)*o),this.punchKind===`uppercut`&&(w=-.2*e*(this.punchHand===`left`?1:-1)*o),this.punchKind===`jab`&&(w=.24*e*(this.punchHand===`left`?1:-1)*o)}this.spineTwist=Qv(this.spineTwist,w,16,n);let T=.34*o;a.root.position.set(s,0,c),a.root.rotation.set(0,this.yaw+T*(1-h),0);let E=this.reactionDirection>=0?1:-1;a.hips.position.y=.98+y+this.drop*(1-h)-h*.82,a.hips.rotation.set(-h*(Math.PI/2-.12)+this.spinePitch*.35*(1-h),0,this.hipsRoll*.5*(1-h)+h*.15*E),a.spine.rotation.set(this.spinePitch*(1-h),this.spineTwist*(1-h),this.hipsRoll*.55*(1-h));let D=-this.spinePitch*.7-g*.55+h*.3,O=-this.hipsRoll*.8+g*.3*(this.reactionDirection>=0?-1:1);a.head.rotation.set(D,-this.spineTwist*.5,O),a.chest.scale.set(1+b,1+b*.5,1+b),this.poseLegs(e,f,h,E,o),a.root.updateMatrixWorld(!0);let k=e.defense===`guard_high`?Hv:e.defense===`guard_low`?Wv:Kv,A=e.defense===`guard_high`?Uv:e.defense===`guard_low`?Gv:qv,ee=ty.copy(k),te=new Q().copy(A),j=new Q().copy(ee);if(e.is_foul_recovery_target&&(j.set(.08,.32,.2),te.set(-.06,.3,.18)),(e.clinch_ticks>0||e.clinch_startup_ticks>0)&&(j.set(.16,-.05,.5),te.set(-.16,-.02,.48)),h>.03?(j.lerp(new Q(.5,.28,-.1),h),te.lerp(new Q(-.48,.3,.05),h)):_>.15&&(j.lerp(new Q(.3,-.25,.15),_*.7),te.lerp(new Q(-.3,-.22,.15),_*.7)),this.punchT<1&&this.punchKind!==null){let e=ey(0,.2,this.punchT)*(1-ey(.16,.45,this.punchT)),t=ey(.18,this.punchKind===`jab`?.42:.5,this.punchT)*(1-ey(.62,1,this.punchT)),n=Zv(this.punchKind,this.punchTargetKind,this.punchPower);if(this.punchKind===`hook`){let e=ey(.18,.55,this.punchT);n.x=Bl.lerp(-.62,-.1,e)*(this.punchHand===`left`?1:-1)*-1,n.z=.5+.14*e}let r=new Q(0,this.punchKind===`uppercut`?-.22:-.03,-.16).multiplyScalar(e),i=(this.punchHand===`left`?j.clone():te.clone()).add(r).lerp(n,t);this.punchHand===`left`?j=i:te.copy(i)}j.x*=o,te.x*=o,this.gloveLCurrent.x=Qv(this.gloveLCurrent.x,j.x,22,n),this.gloveLCurrent.y=Qv(this.gloveLCurrent.y,j.y,22,n),this.gloveLCurrent.z=Qv(this.gloveLCurrent.z,j.z,22,n),this.gloveRCurrent.x=Qv(this.gloveRCurrent.x,te.x,22,n),this.gloveRCurrent.y=Qv(this.gloveRCurrent.y,te.y,22,n),this.gloveRCurrent.z=Qv(this.gloveRCurrent.z,te.z,22,n),this.solveArmIK(a.shoulderL,a.elbowL,a.gloveL,this.gloveLCurrent,1,a),this.solveArmIK(a.shoulderR,a.elbowR,a.gloveR,this.gloveRCurrent,-1,a),this.applyTrauma(e)}poseLegs(e,t,n,r,i){let a=this.rig,o=Math.min(.5,t*.35)*(1-n),s=Math.sin(this.walkPhase)*o,c=-this.drop*1.4*(1-n),l={hip:-.18-c*.5,knee:.26+c,ankle:-.08-c*.5},u={hip:.14-c*.5,knee:.3+c,ankle:-.1-c*.5};a.hipL.rotation.set(Bl.lerp(l.hip+s,-.5,n),.3*i*(1-n),Bl.lerp(0,.5*r,n)),a.kneeL.rotation.x=Bl.lerp(l.knee-s*.8,.7,n),a.ankleL.rotation.x=Bl.lerp(l.ankle,.4,n),a.hipR.rotation.set(Bl.lerp(u.hip-s,-.35,n),-.12*i*(1-n),Bl.lerp(0,.35*r,n)),a.kneeR.rotation.x=Bl.lerp(u.knee+s*.8,.5,n),a.ankleR.rotation.x=Bl.lerp(u.ankle,.4,n)}solveArmIK(e,t,n,r,i,a){e.getWorldPosition(ny),ay.copy(r),a.chest.localToWorld(ay),ry.set(.9*i,-1,-.25).applyQuaternion(a.chest.getWorldQuaternion(new Vl)),Fv(ny,ay,ry,iy),zv(e,ny,iy.elbowWorld),e.updateMatrixWorld(!0),zv(t,iy.elbowWorld,ay)}applyTrauma(e){let t=e.trauma,n=e=>Math.min(.85,e/170+t.swelling/420);this.rig.bruiseL.material.opacity=n(t.left_eye),this.rig.bruiseR.material.opacity=n(t.right_eye),this.rig.cutL.material.opacity=Math.min(1,t.left_cut/200+t.bleeding/600),this.rig.cutR.material.opacity=Math.min(1,t.right_cut/200+t.bleeding/600),this.rig.bodyBruise.material.opacity=Math.min(.7,t.body/950);let r=1+Math.min(.12,t.swelling/2500);this.rig.headMesh.scale.set(.92*r,1.08*r,.98*r)}},sy=[2765120,3813162,2503738,4206894,3029548,3683390,4471856,5919048,3227722,4863298],cy=[13081462,9067067,7225640,14726287,5517341,11105359],ly=e=>()=>(e=Math.imul(e^e>>>15,1|e),e^=e+Math.imul(e^e>>>7,61|e),((e^e>>>14)>>>0)/4294967296);function uy(){let e=new zu;e.name=`arena`;let t=[],n=[],r=[],i=new Rp({color:`#05070c`,roughness:.95});n.push(i);let a=new Jf(30,40);t.push(a);let o=new pf(a,i);o.rotation.x=-Math.PI/2,o.position.y=-1,o.receiveShadow=!0,e.add(o);let s=ly(20260727),c=[{radius:8.2,y:-.55,count:120,scale:1},{radius:10.6,y:.35,count:150,scale:1.04},{radius:13.2,y:1.35,count:180,scale:1.08},{radius:16,y:2.45,count:210,scale:1.12}],l=c.reduce((e,t)=>e+t.count,0),u=new qf(.19,.5,4,8),d=new Ep(.115,8,7);t.push(u,d);let f=new Rp({roughness:.9,metalness:0}),p=new Rp({roughness:.75,metalness:0});n.push(f,p);let m=new Tf(u,f,l),h=new Tf(d,p,l);m.instanceMatrix.setUsage(el),h.instanceMatrix.setUsage(el);let g=new du,_=new Ku,v=new Float32Array(l),y=[],b=0;for(let e of c)for(let t=0;t<e.count;t+=1){let n=t/e.count*Math.PI*2+s()*.03,r=(s()-.5)*.7,i=Math.sin(n)*(e.radius+r),a=Math.cos(n)*(e.radius+r),o=e.y+(s()-.5)*.12,c=Math.atan2(-i,-a)+(s()-.5)*.5,l=e.scale*(.92+s()*.2);y.push({x:i,y:o,z:a,yaw:c,scale:l}),v[b]=s()*Math.PI*2,g.compose(new Q(i,o+.45*l,a),new Vl().setFromAxisAngle(new Q(0,1,0),c),new Q(l,l,l)),m.setMatrixAt(b,g),g.compose(new Q(i,o+.95*l,a),new Vl,new Q(l,l,l)),h.setMatrixAt(b,g),_.setHex(sy[Math.floor(s()*sy.length)]).multiplyScalar(.85+s()*.6),m.setColorAt(b,_),_.setHex(cy[Math.floor(s()*cy.length)]).multiplyScalar(.85+s()*.35),h.setColorAt(b,_),b+=1}m.instanceColor.needsUpdate=!0,h.instanceColor.needsUpdate=!0,e.add(m,h);let x=new Float32Array(270);for(let e=0;e<90;e+=1){let t=c[Math.floor(s()*c.length)],n=s()*Math.PI*2;x[e*3]=Math.sin(n)*t.radius,x[e*3+1]=t.y+.9+s()*.5,x[e*3+2]=Math.cos(n)*t.radius}let S=new Ud;S.setAttribute(`position`,new Od(x,3)),t.push(S);let C=new Pf({color:13623551,size:.09,transparent:!0,opacity:0,blending:2,depthWrite:!1});n.push(C);let w=new zf(S,C);e.add(w);let T=new Rp({color:`#11151d`,roughness:.6,metalness:.4});n.push(T);let E=new Rp({color:`#1a2230`,emissive:`#dfe9ff`,emissiveIntensity:1.1,roughness:.4});n.push(E);let D=new ef({color:`#a8c4ff`,transparent:!0,opacity:.014,blending:2,depthWrite:!1,side:2});n.push(D);let O=new Kf(9,.18,.18);t.push(O);let k=new Yf(.09,.14,.22,10);t.push(k);let A=new Xf(1.7,6.6,20,1,!0);t.push(A);for(let t=0;t<2;t+=1){let n=new pf(O,T);n.position.set(0,7.6,t===0?-1.6:1.6),e.add(n);for(let t=0;t<5;t+=1){let r=-3.6+t*1.8,i=new pf(k,E);i.position.set(r,7.45,n.position.z),e.add(i);let a=new pf(A,D);a.position.set(r,4.1,n.position.z*.4),e.add(a)}}let ee=new Rp({color:`#070a12`,roughness:1});n.push(ee);let te=new Yf(24,24,14,32,1,!0);t.push(te);let j=new pf(te,ee);j.position.y=5,j.material.side=1,e.add(j);let ne=document.createElement(`canvas`);ne.width=512,ne.height=256;let re=ne.getContext(`2d`);re!==null&&(re.fillStyle=`#04060c`,re.fillRect(0,0,512,256),re.strokeStyle=`#f1cc72`,re.lineWidth=6,re.strokeRect(14,14,484,228),re.fillStyle=`#f1cc72`,re.font=`800 84px Inter, system-ui, sans-serif`,re.textAlign=`center`,re.textBaseline=`middle`,re.fillText(`H A N D S`,256,104),re.fillStyle=`#8fa3c8`,re.font=`600 30px Inter, system-ui, sans-serif`,re.fillText(`CHAMPIONSHIP BOXING`,256,186));let ie=new Hf(ne);ie.colorSpace=Jc;let ae=new ef({map:ie});n.push(ae);let oe=new Kf(4.6,2.3,.3);t.push(oe);let se=new pf(oe,ae);se.position.set(0,6.4,-14.5),e.add(se);let ce=new pf(oe,T);ce.position.set(0,6.4,-14.65),e.add(ce),r.push(ie);let le=0,M=0;return{group:e,update:(e,t)=>{if(!t){let t=Math.floor(e*30%l);for(let n=0;n<90;n+=1){let r=(t+n)%l,i=y[r],a=Math.sin(e*1.6+v[r])*.05,o=Math.abs(Math.sin(e*2.3+v[r]*1.7))*.05;g.compose(new Q(i.x,i.y+.45*i.scale+o,i.z+a*.4),new Vl().setFromAxisAngle(new Q(0,1,0),i.yaw+a),new Q(i.scale,i.scale,i.scale)),m.setMatrixAt(r,g),g.compose(new Q(i.x,i.y+.95*i.scale+o*1.2,i.z+a*.5),new Vl().setFromAxisAngle(new Q(0,1,0),i.yaw+a*1.2),new Q(i.scale,i.scale,i.scale)),h.setMatrixAt(r,g)}m.instanceMatrix.needsUpdate=!0,h.instanceMatrix.needsUpdate=!0,le-=1/60,le<=0&&(M=.09+Math.random()*.08,le=.25+Math.random()*1.6),M=Math.max(0,M-1/60),C.opacity=M>0?.85:0}},dispose:()=>{for(let e of t)e.dispose();for(let e of n)e.dispose();for(let e of r)e.dispose();m.dispose(),h.dispose()}}}var dy=1.88,fy=7.15,py=1.12,my=class{current=new Q(0,dy,fy);look=new Q(0,py,0);swayPhase=0;update(e,t,n,r,i,a,o,s){this.swayPhase+=e;let c=(n.x+r.x)/2,l=(n.z+r.z)/2,u=Bl.clamp(c,-1.4,1.4),d=Bl.clamp(l,-1.1,1.1),f=Bl.clamp(fy+i*.42-(a?1.1:0),6.4,9.8),p=dy+i*.1-(a?.35:0),m=s?0:Math.sin(this.swayPhase*.21)*.35,h=s?0:Math.sin(this.swayPhase*.13)*.3,g=u*.32+m,_=f+d*.2,v=p+h*.2;if(this.current.x+=(g-this.current.x)*(1-Math.exp(-2.6*e)),this.current.y+=(v-this.current.y)*(1-Math.exp(-2.6*e)),this.current.z+=(_-this.current.z)*(1-Math.exp(-2.6*e)),this.look.x+=(u-this.look.x)*(1-Math.exp(-3.2*e)),this.look.y+=((a?.75:py)-this.look.y)*(1-Math.exp(-3.2*e)),this.look.z+=(d*.6-this.look.z)*(1-Math.exp(-3.2*e)),!s&&o>5e-4){let e=t*61;this.current.x+=Math.sin(e*1.31)*o,this.current.y+=Math.cos(e*1.97)*o*.6,this.look.x+=Math.sin(e*1.53)*o*.5,this.look.y+=Math.cos(e*2.11)*o*.35}return{position:this.current,lookAt:this.look}}},hy=3.05,gy=3.85,_y=4.05,vy=3.42,yy=[.5,.88,1.26];function by(e){let t=hy/Math.max(1,e.ring_half_width),n=hy/Math.max(1,e.ring_half_height);return{x:e=>e*t,z:e=>e*n,separation:e=>e*t}}var xy={blue:1920728,red:12131356,neutral:15067115},Sy=[{skin:11563071,skinShadow:9065520,trunks:1327211,trunkTrim:14267484,glove:1920728,gloveTrim:15067115,hair:1643537,shoe:2240573},{skin:7225640,skinShadow:5582877,trunks:7017504,trunkTrim:15067115,glove:12131356,gloveTrim:14267484,hair:854794,shoe:2956316}],Cy=700,wy=26,Ty=e=>()=>(e=Math.imul(e^e>>>15,1|e),e^=e+Math.imul(e^e>>>7,61|e),((e^e>>>14)>>>0)/4294967296),Ey=new Set([`hit`,`counter_hit`,`block`,`knockdown`,`bleed`]),Dy=class{scene;points;particleData=[];positions;colors;sizes;geometry;material;decals=[];decalMaterial;decalGeometry;decalIndex=0;shake=0;bloodLevel=`full`;constructor(e){this.scene=e,this.positions=new Float32Array(Cy*3),this.colors=new Float32Array(Cy*3),this.sizes=new Float32Array(Cy),this.geometry=new Ud,this.geometry.setAttribute(`position`,new Od(this.positions,3)),this.geometry.setAttribute(`color`,new Od(this.colors,3)),this.geometry.setAttribute(`size`,new Od(this.sizes,1)),this.material=new Pf({size:.035,vertexColors:!0,transparent:!0,opacity:.9,depthWrite:!1,sizeAttenuation:!0}),this.points=new zf(this.geometry,this.material),this.points.frustumCulled=!1,e.add(this.points);for(let e=0;e<Cy;e+=1)this.particleData.push({alive:!1,x:0,y:-50,z:0,vx:0,vy:0,vz:0,life:0,maxLife:1,size:1,r:1,g:1,b:1});this.decalGeometry=new Jf(.09,12),this.decalMaterial=new ef({color:7212307,transparent:!0,opacity:.42,depthWrite:!1});for(let t=0;t<wy;t+=1){let n=new pf(this.decalGeometry,this.decalMaterial.clone());n.rotation.x=-Math.PI/2,n.position.y=.004+t*2e-4,n.visible=!1,this.decals.push(n),e.add(n)}}setBloodLevel(e){e!==this.bloodLevel&&(this.bloodLevel=e,e===`off`&&this.clearDecals())}get shakeAmount(){return this.shake}get liveParticles(){return this.particleData.filter(e=>e.alive).length}addEvent(e,t,n){if(!Ey.has(e.kind))return;let r=Ty(e.event_id*7919+17),i=e.kind===`block`,a={x:t.x,y:1.58,z:t.z},o=this.bloodLevel===`off`?0:this.bloodLevel===`reduced`?.35:1,s=n?0:Math.round((i?5:12)+Math.min(16,e.amount/24)),c=n?0:Math.round(Math.min(20,e.blood/5)*o);this.shake=Math.min(.09,this.shake+(i?.008:Math.max(.012,e.amount/2600))),e.kind===`knockdown`&&(this.shake=Math.min(.14,this.shake+.06));let l=(t,n,i,o)=>{for(let s=0;s<t;s+=1){let t=this.particleData.find(e=>!e.alive);if(t===void 0)return;let s=r()*Math.PI*2,c=(.4+r()*.9)*i;t.alive=!0,t.x=a.x+(r()-.5)*.12,t.y=a.y+(r()-.5)*.14,t.z=a.z+(r()-.5)*.12,t.vx=Math.sin(s)*c+e.direction*(.5+r()*.9)*i,t.vy=(.6+r()*1.5)*i,t.vz=Math.cos(s)*c,t.maxLife=.5+r()*.5,t.life=t.maxLife,t.size=o*(.7+r()*.7);let l=n();t.r=l.r,t.g=l.g,t.b=l.b}};if(l(s,()=>({r:.82,g:.9,b:1}),.85,1),l(c,()=>({r:.55+r()*.25,g:.05,b:.07}),1,1.25),e.blood>10&&o>0){let e=this.decals[this.decalIndex%wy];this.decalIndex+=1,e.visible=!0,e.position.x=a.x+(r()-.5)*.7,e.position.z=a.z+(r()-.5)*.7;let t=(.6+r()*1.3)*o;e.scale.set(t,t,t),e.material.opacity=.45*o}}update(e){this.shake*=.02**e;for(let[t,n]of this.particleData.entries()){if(!n.alive){this.positions[t*3+1]=-50;continue}if(n.life-=e,n.life<=0||n.y<0){n.alive=!1,this.positions[t*3+1]=-50;continue}n.vy-=4.4*e,n.x+=n.vx*e,n.y+=n.vy*e,n.z+=n.vz*e;let r=Math.min(1,n.life/(n.maxLife*.4));this.positions[t*3]=n.x,this.positions[t*3+1]=n.y,this.positions[t*3+2]=n.z,this.colors[t*3]=n.r*r,this.colors[t*3+1]=n.g*r,this.colors[t*3+2]=n.b*r,this.sizes[t]=n.size}this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.color.needsUpdate=!0,this.geometry.attributes.size.needsUpdate=!0}clearDynamic(){for(let e of this.particleData)e.alive=!1;this.shake=0}clearDecals(){for(let e of this.decals)e.visible=!1}dispose(){this.scene.remove(this.points),this.geometry.dispose(),this.material.dispose(),this.decalGeometry.dispose();for(let e of this.decals)this.scene.remove(e),e.material.dispose();this.decalMaterial.dispose()}},Oy=e=>e.reduce((e,t)=>e+t,0),ky=(e,t,n)=>{if(e.measureText(t).width<=n)return t;let r=t;for(;r.length>1&&e.measureText(`${r}…`).width>n;)r=r.slice(0,-1);return`${r}…`};function Ay(e,t,n,r,i,a){e.fillStyle=`rgba(2,4,9,0.85)`,e.fillRect(t-1,n-1,r+2,11);let o=e.createLinearGradient(0,n,0,n+9);o.addColorStop(0,`rgba(210,220,235,0.5)`),o.addColorStop(.5,`rgba(90,100,120,0.25)`),o.addColorStop(1,`rgba(30,36,50,0.4)`),e.strokeStyle=o,e.lineWidth=1,e.strokeRect(t-1.5,n-1.5,r+3,12);let s=Math.max(0,Math.min(1,i.value/Math.max(1,i.maximum))),c=e.createLinearGradient(0,n,0,n+9);c.addColorStop(0,i.from),c.addColorStop(1,i.to),e.fillStyle=c;let l=r*s;e.fillRect(a?t+r-l:t,n,l,9),e.fillStyle=`rgba(255,255,255,0.22)`,e.fillRect(a?t+r-l:t,n,l,2),e.fillStyle=`#dfe7f5`,e.font=`700 9px Inter, system-ui, sans-serif`,e.textAlign=a?`right`:`left`,e.fillText(i.label,a?t+r:t,n-4)}function jy(e,t,n,r,i,a,o,s,c){e.save(),e.beginPath(),s?(e.moveTo(t+14,n),e.lineTo(t+r,n),e.lineTo(t+r-14,n+62),e.lineTo(t,n+62)):(e.moveTo(t,n),e.lineTo(t+r-14,n),e.lineTo(t+r,n+62),e.lineTo(t+14,n+62)),e.closePath(),e.fillStyle=`rgba(3,6,12,0.82)`,e.fill(),e.strokeStyle=`rgba(190,200,220,0.22)`,e.lineWidth=1,e.stroke(),e.fillStyle=c,e.fillRect(s?t+r-5:t,n+4,5,54);let l=s?t+r-20:t+20;e.textAlign=s?`right`:`left`,e.fillStyle=`#f5f8ff`,e.font=`800 16px Inter, system-ui, sans-serif`,e.fillText(ky(e,i.toUpperCase(),r-44),l,n+21),e.fillStyle=`#93a3bd`,e.font=`600 10px Inter, system-ui, sans-serif`,e.fillText(a,l,n+35);let u=(r-52)/o.length,d=o.length*u+(o.length-1)*12,f=s?t+r-20-d:t+20;o.forEach((t,r)=>{Ay(e,f+(u+12)*r,n+48,u,t,s)}),e.restore()}function My(e,t,n,r,i,a){e.save(),e.beginPath(),e.moveTo(t-168/2+12,n),e.lineTo(t+168/2-12,n),e.lineTo(t+168/2,n+58/2),e.lineTo(t+168/2-12,n+58),e.lineTo(t-168/2+12,n+58),e.lineTo(t-168/2,n+58/2),e.closePath(),e.fillStyle=`rgba(4,6,12,0.88)`,e.fill();let o=e.createLinearGradient(t-168/2,n,t+168/2,n+58);o.addColorStop(0,`#8a6a26`),o.addColorStop(.5,`#f6d57a`),o.addColorStop(1,`#8a6a26`),e.strokeStyle=o,e.lineWidth=2,e.stroke(),e.textAlign=`center`,e.fillStyle=`#ffffff`,e.font=`800 22px ui-monospace, monospace`,e.fillText(r,t,n+27),e.fillStyle=`#f6d57a`,e.font=`800 12px Inter, system-ui, sans-serif`,e.fillText(i,t,n+44),a!==`FIGHT`&&(e.fillStyle=`#93a3bd`,e.font=`700 9px Inter, system-ui, sans-serif`,e.fillText(a,t,n+55)),e.restore()}function Ny(e,t,n,r,i,a=0){let o=t/2-320/2,s=n/2-78/2+a;e.fillStyle=`rgba(3,6,12,0.88)`,e.fillRect(o,s,320,78),e.strokeStyle=`rgba(246,213,122,0.45)`,e.lineWidth=1.5,e.strokeRect(o+2,s+2,316,74),e.textAlign=`center`,e.fillStyle=`#ffd77a`,e.font=`800 22px Inter, system-ui, sans-serif`,e.fillText(r,t/2,s+34),e.fillStyle=`#c8d3e6`,e.font=`600 12px Inter, system-ui, sans-serif`,e.fillText(i,t/2,s+58)}function Py(e,t,n,r,i,a,o,s,c=30){e.save(),e.textBaseline=`alphabetic`;let l=Math.min(300,t*.38),u=n-84;r.fighters.forEach((n,r)=>{let a=r===1,o=a?t-24-l:24,s=i[n.player_id],c=`ELO ${s?.rating??`—`} · KD ${n.knockdowns} · W ${n.warnings} · −${n.deductions}`,d=[{label:`STAMINA ${Math.round(n.stamina)}`,value:n.stamina,maximum:n.maximum_stamina,from:`#ffe08a`,to:`#d9a53a`},{label:`HEALTH ${Math.round(n.conditioning)}`,value:n.conditioning,maximum:n.maximum_stamina,from:`#ff8a7a`,to:`#b02a20`},{label:`GUARD`,value:n.guard,maximum:700,from:`#9ec7ff`,to:`#3d6fb8`},{label:`POISE ${Math.round(n.poise)}`,value:n.poise,maximum:600,from:`#e8c890`,to:`#8a6a34`}];jy(e,o,u,l,s?.name??`Fighter`,c,d.slice(0,2),a,r===0?`#3d6fb8`:`#b02a20`);let f=u-12;Ay(e,a?o+l-148:o+20,f,64,d[2],a),Ay(e,a?o+l-72:o+96,f,64,d[3],a)});let d=Math.floor(r.phase_ticks_remaining/c),f=`${Math.floor(d/60)}:${String(d%60).padStart(2,`0`)}`;if(My(e,t/2,n-84,f,`ROUND ${r.round_number}`,r.phase.replace(`_`,` `).toUpperCase()),r.phase===`knockdown`){let i=r.fighters.find(e=>e.player_id===a),o=Math.max(...r.fighters.map(e=>e.get_up_count)),s=i?.get_up_prompt!==null&&i?.get_up_prompt!==void 0?`YOUR RHYTHM: ${i.get_up_prompt===`get_up_left`?`←`:`→`}  ${i.get_up_meter}/${i.get_up_required}`:`Waiting for the count`;Ny(e,t,n,`COUNT ${o}`,s,-n*.18)}r.phase===`foul_recovery`&&Ny(e,t,n,`FOUL RECOVERY`,`${i[r.fighters.find(e=>e.is_foul_recovery_target)?.player_id??``]?.name??`Fighter`} is recovering`),r.phase===`rest`&&Ny(e,t,n,`CORNERS · RECOVER`,`Conditioning governs recovery`),s>0&&Ny(e,t,n,`OPPONENT RECONNECTING · ${Math.ceil(s/1e3)}s`,`The bout is paused`),o!==null&&Fy(e,t,n,o,i),e.restore()}function Fy(e,t,n,r,i){e.fillStyle=`rgba(2,4,9,0.94)`,e.fillRect(t*.14,n*.13,t*.72,n*.74),e.strokeStyle=`rgba(246,213,122,0.5)`,e.lineWidth=2,e.strokeRect(t*.14+4,n*.13+4,t*.72-8,n*.74-8),e.textAlign=`center`,e.fillStyle=`#f6d57a`,e.font=`800 26px Inter, system-ui, sans-serif`,e.fillText(r.method.replaceAll(`_`,` `).toUpperCase(),t/2,n*.21);let a=r.winner_id===null?`DRAW`:`${i[r.winner_id]?.name??`Winner`} WINS`;e.fillStyle=`white`,e.font=`700 18px Inter, system-ui, sans-serif`,e.fillText(ky(e,a,t*.6),t/2,n*.27),e.font=`12px ui-monospace, monospace`,r.scorecards.forEach((r,i)=>{let a=n*.37+i*36;e.fillStyle=`#aebbd0`,e.fillText(`${ky(e,r.judge,100)}  ${Oy(r.player_one)} — ${Oy(r.player_two)}  [${r.player_one.join(`·`)}] [${r.player_two.join(`·`)}]`,t/2,a)});let o=Object.entries(r.ratings);e.font=`600 13px Inter, system-ui, sans-serif`,o.forEach(([r,a],o)=>{e.fillStyle=a.after>=a.before?`#55df9b`:`#ff7b74`,e.fillText(`${ky(e,i[r]?.name??`Fighter`,100)}  ${a.before} → ${a.after} (${a.after-a.before>=0?`+`:``}${a.after-a.before})`,t/2,n*.61+o*27)})}function Iy(e,t){let n=document.createElement(`canvas`);n.width=e,n.height=e;let r=n.getContext(`2d`);r!==null&&t(r,e);let i=new Hf(n);return i.anisotropy=8,i.colorSpace=Jc,i}function Ly(){return Iy(1024,(e,t)=>{e.fillStyle=`#2c4386`,e.fillRect(0,0,t,t);let n=e.createLinearGradient(0,0,t,t);n.addColorStop(0,`rgba(255,255,255,0.05)`),n.addColorStop(.5,`rgba(0,0,0,0.04)`),n.addColorStop(1,`rgba(255,255,255,0.03)`),e.fillStyle=n,e.fillRect(0,0,t,t);for(let n=0;n<900;n+=1){let r=Math.sin(n*12.9898)*43758.5453%1,i=Math.sin(n*78.233)*12543.1234%1;e.fillStyle=`rgba(${n%2==0?`255,255,255`:`10,20,50`},${.015+n%5*.004})`,e.fillRect(Math.abs(r)*t,Math.abs(i)*t,2+n%3,1+n%2)}e.strokeStyle=`rgba(235,240,255,0.9)`,e.lineWidth=10,e.beginPath(),e.arc(t/2,t/2,t*.2,0,Math.PI*2),e.stroke(),e.fillStyle=`rgba(235,240,255,0.92)`,e.font=`800 ${Math.round(t*.062)}px Inter, system-ui, sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`H A N D S`,t/2,t/2-t*.012),e.font=`600 ${Math.round(t*.024)}px Inter, system-ui, sans-serif`,e.fillText(`AUTHORITATIVE BOXING`,t/2,t/2+t*.052),e.strokeStyle=`rgba(235,240,255,0.55)`,e.lineWidth=5,e.strokeRect(t*.035,t*.035,t*.93,t*.93)})}function Ry(){return Iy(512,(e,t)=>{e.fillStyle=`#101b33`,e.fillRect(0,0,t,t),e.fillStyle=`#f1cc72`,e.font=`800 ${Math.round(t*.09)}px Inter, system-ui, sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`;for(let n=0;n<4;n+=1)e.fillText(`H A N D S`,t*(.125+n*.25),t/2)})}function zy(){let e=[],t=[],n=[],r=new zu;r.name=`ring`;let i=Ly();n.push(i);let a=new Rp({map:i,roughness:.92,metalness:0});t.push(a);let o=new wp(hy*2,hy*2);e.push(o);let s=new pf(o,a);s.rotation.x=-Math.PI/2,s.position.y=.002,s.receiveShadow=!0,r.add(s);let c=Ry();n.push(c);let l=new Rp({color:`#16233f`,roughness:.85});t.push(l);let u=new Tp(hy*.98,gy,4,1);e.push(u);let d=new pf(u,l);d.rotation.x=-Math.PI/2,d.rotation.z=Math.PI/4,d.position.y=.001,d.receiveShadow=!0,r.add(d);let f=new Rp({color:`#0c1424`,roughness:.9});t.push(f);let p=new Kf(_y*2,1,_y*2);e.push(p);let m=new pf(p,f);m.position.y=-.5,m.receiveShadow=!0,r.add(m);let h=new Rp({color:`#101b33`,roughness:.95});t.push(h);for(let t=0;t<4;t+=1){let n=new wp(_y*2,.95);e.push(n);let i=new pf(n,h),a=t*Math.PI/2;i.position.set(Math.sin(a)*(_y-.001),-.48,Math.cos(a)*(_y-.001)),i.rotation.y=a,r.add(i)}let g=new Rp({color:`#9aa7b5`,roughness:.35,metalness:.75});t.push(g);let _=[xy.blue,xy.neutral,xy.red,xy.neutral],v=new Yf(.055,.055,1.55,12);e.push(v);let y=new Kf(.34,.52,.13);e.push(y);let b=new Kf(.16,.07,.1);e.push(b);let x=[];for(let e=0;e<4;e+=1){let n=Math.PI/4+e*Math.PI/2,i=Math.sin(n)*vy*Math.SQRT2*.72,a=Math.cos(n)*vy*Math.SQRT2*.72;x.push(new Q(i,0,a));let o=new pf(v,g);o.position.set(i,.78,a),o.castShadow=!0,r.add(o);let s=new Rp({color:_[e],roughness:.55});t.push(s);for(let e of[.62,1.12]){let t=new pf(y,s);t.position.set(i*.985,e,a*.985),t.lookAt(0,e,0),t.castShadow=!0,r.add(t)}}let S=[12131356,15067115,1920728].map(e=>{let n=new Rp({color:e,roughness:.42,metalness:.05});return t.push(n),n});for(let n=0;n<4;n+=1){let i=x[n],a=x[(n+1)%4];for(let[n,o]of yy.entries()){let s=i.clone().add(a).multiplyScalar(.5);s.y=o-.045;let c=new Sp(new Q(i.x,o,i.z),s,new Q(a.x,o,a.z)),l=new Dp(c,24,.028,8,!1);e.push(l);let u=new pf(l,S[n]);u.castShadow=!0,r.add(u);for(let n of[.33,.66]){let i=c.getPoint(n),a=new Kf(.035,.82,.012);e.push(a);let s=new Rp({color:14212840,roughness:.6});t.push(s);let l=new pf(a,s);l.position.set(i.x,o-.36,i.z),l.lookAt(0,o-.36,0),r.add(l)}}}return{group:r,materials:t,geometries:e,textures:n}}function By(e){for(let t of e.geometries)t.dispose();for(let t of e.materials)t.dispose();for(let t of e.textures)t.dispose()}function Vy(e,t=2){let n=e.getBoundingClientRect(),r=Math.max(1,Math.round(n.width)),i=Math.max(1,Math.round(n.height)),a=Math.min(t,Math.max(1,window.devicePixelRatio||1));(e.width!==Math.round(r*a)||e.height!==Math.round(i*a))&&(e.width=Math.round(r*a),e.height=Math.round(i*a));let o=e.getContext(`2d`);return o===null?null:(o.setTransform(a,0,0,a,0,0),{context:o,viewport:{width:r,height:i},dpr:a})}function Hy(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);if(t!==null){let e=t.createRadialGradient(64,64,8,64,64,62);e.addColorStop(0,`rgba(0,0,0,0.68)`),e.addColorStop(.6,`rgba(0,0,0,0.34)`),e.addColorStop(1,`rgba(0,0,0,0)`),t.fillStyle=e,t.fillRect(0,0,128,128)}return new Hf(e)}var Uy={tick_rate:30,ring_half_width:500,ring_half_height:330},Wy=class{canvas;simulation;settings;renderer;scene=new Yu;camera;composer;ring;arena;boxers;referee;refereePosition=new Q(.4,0,-2.1);animators;effects;director=new my;mapping;buffer=new bs;dedupe=new xs;hudCanvas;blobShadows=[];blobTexture;lights=[];raf=0;previous=performance.now();players={};viewerId=null;final=null;reconnectMs=0;destroyed=!1;tmpA=new Q;tmpB=new Q;constructor(e,t=Uy,n){this.canvas=e,this.simulation=t,this.settings=n,this.mapping=by(t),this.renderer=new ov({canvas:e,antialias:!0,powerPreference:`high-performance`}),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=1,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1,this.renderer.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),this.scene.background=new Ku(`#04060b`),this.scene.fog=new Ju(`#04060b`,.042),this.camera=new _m(38,1,.1,80),this.camera.position.set(0,2.05,7.6),this.camera.lookAt(0,1.1,0),this.setupLights(),this.ring=zy(),this.scene.add(this.ring.group),this.arena=uy(),this.scene.add(this.arena.group),this.effects=new Dy(this.scene),this.boxers=[Ev(Sy[0]),Ev(Sy[1])],this.animators=[new oy(this.boxers[0],this.mapping),new oy(this.boxers[1],this.mapping)],this.boxers[0].root.position.set(-.9,0,0),this.boxers[1].root.position.set(.9,0,0),this.boxers[0].root.rotation.y=Math.PI/2,this.boxers[1].root.rotation.y=-Math.PI/2,this.scene.add(this.boxers[0].root,this.boxers[1].root),this.referee=Bv(),this.referee.root.position.copy(this.refereePosition),this.referee.shoulderL.rotation.x=-.42,this.referee.shoulderR.rotation.x=-.42,this.referee.elbowL.rotation.x=-.55,this.referee.elbowR.rotation.x=-.55,this.scene.add(this.referee.root),this.blobTexture=Hy();let r=new wp(1,1);for(let e=0;e<3;e+=1){let t=new pf(r,new ef({map:this.blobTexture,transparent:!0,depthWrite:!1}));t.rotation.x=-Math.PI/2,t.position.y=.006+e*4e-4,t.renderOrder=1,this.blobShadows.push(t),this.scene.add(t)}this.composer=new hv(this.renderer),this.composer.addPass(new gv(this.scene,this.camera));let i=new vv(new Z(1280,720),.32,.5,.85);this.composer.addPass(i),this.composer.addPass(new bv),this.hudCanvas=document.createElement(`canvas`),this.hudCanvas.className=`fight-hud`,this.hudCanvas.style.cssText=`position:absolute;inset:0;width:100%;height:100%;pointer-events:none`,e.insertAdjacentElement(`afterend`,this.hudCanvas),this.effects.setBloodLevel(n().blood),this.raf=requestAnimationFrame(e=>this.draw(e))}setPlayers(e,t){this.players=e,this.viewerId=t}setFinal(e){this.final=e}setReconnect(e){this.reconnectMs=e}setBloodLevel(e){this.effects.setBloodLevel(e)}setReducedMotion(e){e&&this.effects.clearDynamic()}push(e){if(this.buffer.push(e))for(let t of this.dedupe.accept(e.events)){let n=e.fighters.find(e=>e.player_id===t.target_id)??e.fighters.find(e=>e.player_id===t.actor_id)??e.fighters[0];this.tmpA.set(this.mapping.x(n.x),0,this.mapping.z(n.y)),this.effects.addEvent(t,this.tmpA,this.settings().reducedMotion);let r=e.fighters.findIndex(e=>e.player_id===t.target_id);r>=0&&[`hit`,`counter_hit`,`block`,`knockdown`].includes(t.kind)&&this.animators[r].impact({direction:t.direction,amount:t.kind===`block`?t.amount*.35:t.amount,blocked:t.kind===`block`})}}setupLights(){let e=new am(`#33415e`,`#05060a`,.5);this.scene.add(e),this.lights.push(e);let t=new Cm(`#2b3450`,.55);this.scene.add(t),this.lights.push(t);let n=new ym(`#fff4e0`,115,26,.68,.6,1.6);n.position.set(0,7.4,.9),n.target.position.set(0,0,0),n.castShadow=!0,n.shadow.mapSize.set(2048,2048),n.shadow.bias=-4e-4,n.shadow.camera.near=3,n.shadow.camera.far=14,this.scene.add(n,n.target),this.lights.push(n);for(let[e,t,n,r]of[[`#b9cdff`,-6.5,4.4,-5.2],[`#ffd9b9`,6.2,4.1,-5.6],[`#9fb8ff`,-5.4,3.6,6],[`#c9d8ff`,5.8,3.9,5.7]]){let i=new ym(e,60,30,.7,.8,1.8);i.position.set(t,n,r),i.target.position.set(0,1,0),this.scene.add(i,i.target),this.lights.push(i)}let r=new Sm(`#dfe9ff`,.7);r.position.set(0,3.4,-6.5),this.scene.add(r),this.lights.push(r)}draw(e){if(this.destroyed)return;let t=Math.min(.05,Math.max(.001,(e-this.previous)/1e3));this.previous=e;let n=this.canvas.clientWidth,r=this.canvas.clientHeight;if(n>0&&r>0){let e=new Z;this.renderer.getSize(e),(e.x!==n||e.y!==r)&&(this.renderer.setSize(n,r,!1),this.composer.setSize(n,r),this.camera.aspect=n/r,this.camera.updateProjectionMatrix())}let i=e/1e3,a=this.settings();this.effects.setBloodLevel(a.blood);let o=this.buffer.latest(),s=o===null?null:this.buffer.sample(o.tick-1),c=1.8,l=!1;if(s!==null){let[e,n]=s.fighters;this.animators[0].update(e,n,t,i,a.reducedMotion),this.animators[1].update(n,e,t,i,a.reducedMotion);let r=this.mapping.x(e.x),o=this.mapping.z(e.y),u=this.mapping.x(n.x),d=this.mapping.z(n.y);c=Math.hypot(r-u,o-d),l=e.is_downed||n.is_downed,this.tmpA.set(r,0,o),this.tmpB.set(u,0,d)}else this.tmpA.set(-.9,0,0),this.tmpB.set(.9,0,0);this.arena.update(i,a.reducedMotion),this.effects.update(t),this.updateReferee(t,i,a.reducedMotion),this.updateBlobShadows();let u=this.director.update(t,i,{x:this.tmpA.x,z:this.tmpA.z},{x:this.tmpB.x,z:this.tmpB.z},c,l,this.effects.shakeAmount,a.reducedMotion);this.camera.position.copy(u.position),this.camera.lookAt(u.lookAt),this.composer.render(),this.drawHudOverlay(s),this.destroyed||(this.raf=requestAnimationFrame(e=>this.draw(e)))}updateBlobShadows(){let e=[this.tmpA,this.tmpB,this.refereePosition];for(let[t,n]of this.blobShadows.entries()){let r=e[t];n.position.x=r.x,n.position.z=r.z;let i=t<2&&this.buffer.latest()?.fighters[t]?.is_downed===!0;n.scale.set(i?2.1:1.25,i?.9:.85,1)}}updateReferee(e,t,n){let r=(this.tmpA.x+this.tmpB.x)/2,i=(this.tmpA.z+this.tmpB.z)/2,a=new Q(this.refereePosition.x-r,0,this.refereePosition.z-i);a.lengthSq()<.01&&a.set(0,0,-1),a.normalize();let o=Bl.clamp(r+a.x*2.05,-2.4,2.4),s=Bl.clamp(i+a.z*2.05,-2.4,2.4),c=1-Math.exp(-1.6*e);this.refereePosition.x+=(o-this.refereePosition.x)*c,this.refereePosition.z+=(s-this.refereePosition.z)*c;for(let e of[this.tmpA,this.tmpB]){let t=this.refereePosition.x-e.x,n=this.refereePosition.z-e.z,r=Math.hypot(t,n);r<1.45&&r>.001&&(this.refereePosition.x=e.x+t/r*1.45,this.refereePosition.z=e.z+n/r*1.45)}this.referee.root.position.set(this.refereePosition.x,0,this.refereePosition.z);let l=Math.atan2(r-this.refereePosition.x,i-this.refereePosition.z);this.referee.root.rotation.y+=(l-this.referee.root.rotation.y)*(1-Math.exp(-3*e)),this.referee.hips.position.y=.98+(n?0:Math.sin(t*1.7)*.006)}drawHudOverlay(e){let t=Vy(this.hudCanvas);if(t===null)return;let{context:n,viewport:r}=t;if(n.clearRect(0,0,r.width,r.height),e===null)return;let i=Math.max(...e.fighters.map(e=>e.trauma.head+e.trauma.body));if(i>350){let e=n.createRadialGradient(r.width/2,r.height/2,r.width*.2,r.width/2,r.height/2,r.width*.72);e.addColorStop(0,`rgba(90,0,8,0)`),e.addColorStop(1,`rgba(75,0,8,${Math.min(.3,i/4600)})`),n.fillStyle=e,n.fillRect(0,0,r.width,r.height)}Py(n,r.width,r.height,e,this.players,this.viewerId,this.final,this.reconnectMs,this.simulation.tick_rate)}destroy(){if(!this.destroyed){this.destroyed=!0,cancelAnimationFrame(this.raf),this.raf=0,this.buffer.clear(),this.dedupe.reset(),this.effects.dispose(),this.arena.dispose(),By(this.ring);for(let e of this.boxers)this.scene.remove(e.root),Vv(e);this.scene.remove(this.referee.root),Vv(this.referee);for(let e of this.lights)this.scene.remove(e);this.composer.dispose(),this.renderer.dispose(),this.blobTexture.dispose();for(let e of this.blobShadows)this.scene.remove(e),e.geometry.dispose(),e.material.dispose();this.hudCanvas.remove()}}},Gy=`hands.preferences.v1`,Ky={length:0,clear:()=>void 0,getItem:()=>null,key:()=>null,removeItem:()=>void 0,setItem:()=>void 0},qy=()=>{try{return window.localStorage}catch{return Ky}},Jy=()=>({volume:.7,haptics:!0,reducedMotion:window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches??!1,blood:`full`});function Yy(e=qy()){let t=Jy();try{let n=JSON.parse(e.getItem(Gy)??`null`);if(typeof n!=`object`||!n||Array.isArray(n))return t;let r=n;return{volume:typeof r.volume==`number`&&Number.isFinite(r.volume)?Math.max(0,Math.min(1,r.volume)):t.volume,haptics:typeof r.haptics==`boolean`?r.haptics:t.haptics,reducedMotion:typeof r.reducedMotion==`boolean`?r.reducedMotion:t.reducedMotion,blood:r.blood===`reduced`||r.blood===`off`||r.blood===`full`?r.blood:t.blood}}catch{return t}}function Xy(e,t=qy()){try{t.setItem(Gy,JSON.stringify({volume:Math.max(0,Math.min(1,e.volume)),haptics:e.haptics,reducedMotion:e.reducedMotion,blood:e.blood}))}catch{}}var Zy=class{value;listeners=new Set;constructor(e=qy()){this.storage=e,this.value=Yy(e)}storage;get current(){return this.value}update(e){this.value={...this.value,...e},Xy(this.value,this.storage);for(let e of this.listeners)e(this.value)}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}destroy(){this.listeners.clear()}},Qy={stage:`bootstrapping`,player:null,playerId:null,role:null,players:{},simulation:null,snapshot:null,final:null,serverTick:0,nextSequence:0,reconnectMs:0,safeError:null},$y=e=>Object.fromEntries(e.map(e=>[e.id,e]));function eb(e,t){if(t.type===`bootstrap`)return{...e,stage:`authorizing`,simulation:t.simulation,safeError:null};if(t.type===`authorized`)return{...e,stage:`connecting`,player:t.player,safeError:null};if(t.type===`connecting`)return{...e,stage:`connecting`};if(t.type===`reconnect-tick`)return{...e,stage:`paused`,reconnectMs:Math.max(0,t.remainingMs)};if(t.type===`fatal`)return{...e,stage:`fatal`,safeError:t.code,reconnectMs:0};let n=t.message;switch(n.type){case`welcome`:return{...e,playerId:n.role===`fighter`?n.player_id:null,role:n.role,players:$y(n.players),serverTick:n.server_tick,nextSequence:n.role===`fighter`?n.next_sequence:0,safeError:null};case`ticket`:return e;case`waiting`:return{...e,stage:`waiting`};case`ready`:return{...e,stage:e.snapshot?.phase??`countdown`,players:$y(n.players)};case`paused`:return{...e,stage:`paused`,reconnectMs:n.grace_ms};case`resumed`:return{...e,stage:e.snapshot?.phase??`countdown`,reconnectMs:0};case`snapshot`:return{...e,stage:n.payload.phase,snapshot:n.payload,serverTick:Math.max(e.serverTick,n.payload.tick)};case`final`:return{...e,stage:`complete`,final:n,reconnectMs:0};case`error`:return{...e,stage:`fatal`,safeError:n.code,reconnectMs:0}}}var tb=class{root;reloadPage;state=Qy;settings=new Zy;input=new _s;audio=new n(()=>this.settings.current);haptics=new ts(()=>this.settings.current);feedbackEvents=new xs;renderer=null;network=null;session=null;abort=new AbortController;destroyed=!1;generation=0;reloadOnRetry=!1;canvas;status;roleIndicator;controlsButton;controlsPanel;retry;fightSummary;liveFightStatus;finalSummary;constructor(e,t=()=>window.location.reload()){this.root=e,this.reloadPage=t,e.innerHTML=`<section class="activity" aria-label="Hands boxing activity"><canvas class="fight" aria-label="Authoritative two-player boxing match"></canvas><header class="topbar"><strong>HANDS</strong><span>authoritative two-player boxing</span><span class="spectator-role" data-role hidden>SPECTATING · READ ONLY</span><button type="button" data-controls aria-expanded="false">Controls</button><button type="button" data-settings aria-expanded="false">Settings</button></header><section class="overlay" data-overlay><p class="status" data-status></p><button type="button" class="primary" data-retry hidden>Retry securely</button></section><aside class="panel" data-controls-panel hidden aria-label="Controls"><h2>Controls</h2><ul>${as.map(e=>`<li>${e}</li>`).join(``)}</ul></aside><aside class="panel settings" data-settings-panel hidden aria-label="Accessibility and feedback settings"><h2>Settings</h2><label>Volume <input data-volume type="range" min="0" max="1" step="0.05"></label><label><input data-haptics type="checkbox"> Haptics</label><label><input data-motion type="checkbox"> Reduced motion</label><label>Blood <select data-blood><option value="full">Full</option><option value="reduced">Reduced</option><option value="off">Off</option></select></label></aside><section class="sr-summary" data-fight-summary aria-label="Fight summary"></section><p class="sr-summary" data-fight-status role="status" aria-live="polite" aria-atomic="true"></p><section class="sr-summary" data-final aria-live="polite" aria-label="Final result"></section></section>`,this.canvas=e.querySelector(`canvas`),this.status=e.querySelector(`[data-status]`),this.roleIndicator=e.querySelector(`[data-role]`),this.controlsButton=e.querySelector(`[data-controls]`),this.controlsPanel=e.querySelector(`[data-controls-panel]`),this.retry=e.querySelector(`[data-retry]`),this.fightSummary=e.querySelector(`[data-fight-summary]`),this.liveFightStatus=e.querySelector(`[data-fight-status]`),this.finalSummary=e.querySelector(`[data-final]`),this.retry.addEventListener(`click`,this.onRetry),this.bindPanels(),this.syncSettings()}start(){this.authorize()}resetForAuthorization(){this.reloadOnRetry=!1,this.network?.dispose(),this.network=null,this.session?.destroy(),this.session=null,this.renderer?.destroy(),this.renderer=null,this.abort.abort(),this.abort=new AbortController,this.state=Qy,this.feedbackEvents.reset(),this.input.setActive(!1),this.input.reset(),this.finalSummary.textContent=``,this.fightSummary.textContent=``,this.liveFightStatus.textContent=``}async authorize(){let e=++this.generation;this.resetForAuthorization(),this.dispatch({type:`connecting`}),this.setText(this.status,`Securing Discord Activity session…`),this.retry.hidden=!0;try{let t=await $o(this.abort.signal);if(this.destroyed||e!==this.generation){t.destroy();return}this.session=t,this.dispatch({type:`bootstrap`,simulation:t.bootstrap.simulation}),this.dispatch({type:`authorized`,player:t.player}),this.renderer=new Wy(this.canvas,t.bootstrap.simulation,()=>this.settings.current);let n=t.takeTicket();if(n===null)throw Error(`ticket_unavailable`);let r=new Ts(n,()=>this.input.frame(),{onMessage:e=>this.receive(e),onReconnect:e=>{this.dispatch({type:`reconnect-tick`,remainingMs:e}),this.renderer?.setReconnect(e),this.renderState()},onFatal:e=>this.fail(e),onFreshAuth:()=>{e===this.generation&&this.authorize()}});this.network=r,r.start(),this.setText(this.status,`Connecting to the ring…`)}catch(t){!this.abort.signal.aborted&&e===this.generation&&(this.reloadOnRetry=t instanceof M&&t.reloadRequired,this.fail(me(t)))}}receive(e){if(e.type===`error`){this.fail(e.code);return}this.dispatch({type:`message`,message:e}),e.type===`snapshot`&&this.receiveSnapshot(e.payload),e.type===`final`&&(this.renderer?.setFinal(e),this.audio.result(e)),this.renderer?.setPlayers(this.state.players,this.state.playerId),this.renderer?.setReconnect(this.state.reconnectMs),this.renderState()}receiveSnapshot(e){this.renderer?.push(e);let t=e.fighters.find(e=>e.player_id===this.state.playerId);this.input.setKnockdown(t?.is_downed===!0),t!==void 0&&this.audio.snapshot(e.tick,t.stamina,t.maximum_stamina,t.trauma.head+t.trauma.body);for(let t of this.feedbackEvents.accept(e.events))this.audio.event(t),this.haptics.event(t)}dispatch(e){this.state=eb(this.state,e)}setText(e,t){e.textContent!==t&&(e.textContent=t)}renderState(){let e={bootstrapping:`Loading…`,authorizing:`Authorizing with Discord…`,connecting:`Connecting securely…`,waiting:`Waiting for one opponent to use Play now in this channel.`,countdown:`Bout countdown.`,fight:`Round ${this.state.snapshot?.round_number??1} in progress.`,knockdown:`Knockdown count ${this.state.snapshot?.fighters.find(e=>e.player_id===this.state.playerId)?.get_up_count??0}.`,foul_recovery:`Foul recovery in progress.`,rest:`Between-round rest.`,paused:`Connection paused. ${Math.ceil(this.state.reconnectMs/1e3)} seconds remain.`,complete:`Bout complete. Scorecards and rating changes are displayed.`,fatal:`Unable to continue (${this.state.safeError??`safe_error`}).`},t=this.state.role===`spectator`;this.setText(this.status,t?`Spectating — ${e[this.state.stage]}`:e[this.state.stage]),this.roleIndicator.hidden=!t,this.controlsButton.hidden=t,t&&(this.controlsPanel.hidden=!0,this.controlsButton.setAttribute(`aria-expanded`,`false`));let n=this.state.snapshot?.fighters.find(e=>e.player_id===this.state.playerId),r=t?`Spectating. ${e[this.state.stage]}`:this.state.stage===`knockdown`&&n?.is_downed===!0?`Knockdown. Count ${n.get_up_count}. ${n.get_up_prompt===null?`Wait for your private rhythm instruction.`:`Press ${n.get_up_prompt===`get_up_left`?`left`:`right`} now.`}`:this.state.stage===`paused`?`Connection paused.`:e[this.state.stage];this.setText(this.liveFightStatus,r),this.retry.hidden=this.state.stage!==`fatal`;let i=!t&&[`countdown`,`fight`,`knockdown`,`foul_recovery`].includes(this.state.stage);if(this.input.setActive(i),this.network?.setActive(i),this.renderFightSummary(),this.state.final!==null){let e=this.state.final;this.setText(this.finalSummary,`${e.method.replaceAll(`_`,` `)}. ${e.winner_id===null?`Draw`:`${this.state.players[e.winner_id]?.name??`Winner`} wins`}. Scorecards: ${e.scorecards.map(e=>`${e.judge}: ${e.player_one.reduce((e,t)=>e+t,0)} to ${e.player_two.reduce((e,t)=>e+t,0)}`).join(`; `)}. Ratings: ${Object.entries(e.ratings).map(([e,t])=>`${this.state.players[e]?.name??`fighter`} ${t.before} to ${t.after}`).join(`; `)}.`)}}renderFightSummary(){let e=this.state.snapshot;if(e===null)return;let t=this.state.simulation?.tick_rate??30,n=Math.floor(e.phase_ticks_remaining/t),r=`${Math.floor(n/60)}:${String(n%60).padStart(2,`0`)}`,i=e.fighters.map(e=>{let t=this.state.players[e.player_id];return`${t?.name??`Fighter`}, ELO ${t?.rating??`unknown`}, stamina ${Math.round(e.stamina)} of ${Math.round(e.maximum_stamina)}, guard ${Math.round(e.guard)}, poise ${Math.round(e.poise)}, conditioning ${Math.round(e.conditioning)}, ${e.warnings} warnings, ${e.knockdowns} knockdowns`}),a=e.fighters.find(e=>e.player_id===this.state.playerId),o=a?.is_downed===!0?a.get_up_prompt===null?`You are down. Count ${a.get_up_count}. Wait for your private rhythm instruction.`:`You are down. Count ${a.get_up_count}. Press ${a.get_up_prompt===`get_up_left`?`left`:`right`} now. Get-up progress ${a.get_up_meter} of ${a.get_up_required}.`:``;this.setText(this.fightSummary,`Round ${e.round_number}. ${e.phase.replace(`_`,` `)}. Clock ${r}. ${i.join(`. `)}. ${o}`.trim())}onRetry=()=>{if(this.reloadOnRetry){this.reloadPage();return}this.authorize()};bindPanels(){let e=(e,t)=>{let n=this.root.querySelector(e),r=this.root.querySelector(t);n.addEventListener(`click`,()=>{r.hidden=!r.hidden,n.setAttribute(`aria-expanded`,String(!r.hidden))})};e(`[data-controls]`,`[data-controls-panel]`),e(`[data-settings]`,`[data-settings-panel]`),this.root.querySelector(`[data-volume]`).addEventListener(`input`,e=>{this.settings.update({volume:Number(e.target.value)}),this.audio.setVolume()}),this.root.querySelector(`[data-haptics]`).addEventListener(`change`,e=>{this.settings.update({haptics:e.target.checked})}),this.root.querySelector(`[data-motion]`).addEventListener(`change`,e=>{let t=e.target.checked;this.settings.update({reducedMotion:t}),this.renderer?.setReducedMotion(t)}),this.root.querySelector(`[data-blood]`).addEventListener(`change`,e=>{let t=e.target.value;this.settings.update({blood:t}),this.renderer?.setBloodLevel(t)})}syncSettings(){let e=this.settings.current;this.root.querySelector(`[data-volume]`).value=String(e.volume),this.root.querySelector(`[data-haptics]`).checked=e.haptics,this.root.querySelector(`[data-motion]`).checked=e.reducedMotion,this.root.querySelector(`[data-blood]`).value=e.blood}fail(e){this.dispatch({type:`fatal`,code:e}),this.network?.dispose(),this.network=null,this.session?.destroy(),this.session=null,this.renderer?.destroy(),this.renderer=null,this.input.setActive(!1),this.input.reset(),this.renderState()}destroy(){this.destroyed||(this.destroyed=!0,this.generation+=1,this.abort.abort(),this.network?.dispose(),this.session?.destroy(),this.renderer?.destroy(),this.input.destroy(),this.audio.destroy(),this.settings.destroy(),this.retry.removeEventListener(`click`,this.onRetry),this.root.replaceChildren())}},nb=document.querySelector(`#app`);if(nb===null)throw Error(`app_root_missing`);var rb;{let e=new tb(nb);e.start(),rb=()=>e.destroy()}window.addEventListener(`pagehide`,rb,{once:!0});