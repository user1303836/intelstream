...
describe("authoritative state reducer", () => {
  it("moves through wait, ready, combat, pause, resume and final without client outcomes", () => {
    let state = reduceState(initialState, { type: "message", message: { version: 1, type: "welcome", player_id: "one", seat: 1, rating: 1500, players: [publicPlayers[0]], server_tick: 0, next_sequence: 7 } });
